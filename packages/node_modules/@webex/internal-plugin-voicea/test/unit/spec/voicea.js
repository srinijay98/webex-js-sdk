  ...
  describe('voicea', () => {
    ...
    describe('#turnOnCaptions', () => {
      ...
      it('doesn\'t call API on captions', async () => {
        ...
        voiceaService._emit('event:relay.event', {headers: {from: 'ws'}, data: {relayType: 'voicea.annc', voiceaPayload: {}}});
    ...
    describe('#processTranscription', () => {
      ...
      it('processes final transcription', async () => {
        ...
        assert.calledOnceWithExactly(functionSpy, voiceaPayload);
        assert.calledOnceWithExactly(triggerSpy, {
          isFinal: true, transcriptId: '3ec73890-bffb-f28b-e77f-99dc13caea7e', translations: undefined, timestamp: '0:01', transcript: {text: 'Hello?', csis: [3556942592], transcriptLanguageCode: 'en'}
        });
      });
